...
namespace Domain.Aggregates.Users
{
		...
		SeedWork.IEntityHasUpdateDateTime
	{
		...
		public User(string emailAddress) : base()
		{
			...
			UserLogins =
				new System.Collections.Generic.List<Aggregates.Users.UserLogin>();
		}
		...
		//	(ErrorMessageResourceType = typeof(Resources.Messages.Validations),
		//	ErrorMessageResourceName = nameof(Resources.Messages.Validations.Required))]
		public virtual Aggregates.Roles.Role? Role { get; set; }
		// **********
		// **********
		// **********
		...
		// **********
		public virtual System.Collections.Generic.IList<Aggregates.Users.UserLogin> UserLogins { get; private set; }
		// **********
	}
}
